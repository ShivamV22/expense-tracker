...
function AddTransaction(props) {
  ...
  return React.createElement("div", {
              className: "transactionContainer"
                ...
                }, React.createElement("p", undefined, "Add new transaction")), React.createElement("div", {
                  className: "inputContainer"
                }, React.createElement("p", undefined, "Text"), React.createElement("input", {
                      placeholder: "Enter text...",
                      value: title,
                      onChange: onTitleChange
                    })), React.createElement("div", {
                  className: "inputContainer"
                }, React.createElement("p", undefined, "Amount"), React.createElement("p", undefined, "(negative - expense, positive - income)"), React.createElement("input", {
